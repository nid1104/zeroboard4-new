...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text  name=header_url value='' size=40 maxlength=255 class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <textarea name=header cols=70 rows=10 class=textarea style=border-color:b0b0b0></textarea>
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text  name=footer_url value='' size=40 maxlength=255 class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <textarea name=footer cols=70 rows=10 class=textarea style=border-color:#b0b0b0></textarea>
  </td>
</tr>

...
$check_open = array(0 => '', 1 => '');
$check_join = array(0 => '', 1 => '');
$check_use_icon = array(0 => '', 1 => '', 2 => '');
...
<input type=hidden name=group_no value=<?= e($group_no) ?>>
  ...
  <tr align=right bgcolor=#e0e0e0><td style=font-family:Tahoma;font-size:8pt;> <font color=red>*</font> <b>그룹이름</b>&nbsp;&nbsp;</td><td align=left>&nbsp;<input value="<?= e($data['name']) ?>" type=text name=name size=20 maxlength=20 class=input style=border-color:#b0b0b0> 그룹이름을 입력하세요</td></tr>
...
<br><?php if ($data['icon']) echo "&nbsp;<b>현재 아이콘이 저장되어 있습니다 (<img src=\"icon/" . e($data['icon']) . "\" border=0> <input type=checkbox name=del_icon value=1> 삭제)"; ?></td></tr>

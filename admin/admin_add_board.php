...
if (!isset($data['header'])) $data['header'] = "<div align=center>";
if (!isset($data['footer'])) $data['footer'] = "</div>";
if (!isset($data['memo_num'])) $data['memo_num'] = 20;

$data += array(
    'no' => '', 'name' => '', 'skinname' => '', 'title' => '', 'header_url' => '', 'footer_url' => '',
    'bg_image' => '', 'max_upload_size' => '2097152', 'pds_ext1' => '', 'pds_ext2' => '',
    'only_board' => '1', 'use_category' => '0', 'use_status' => '1', 'use_pds' => '0',
    'use_homelink' => '0', 'use_filelink' => '0', 'use_showip' => '0',
    'filter' => '', 'avoid_tag' => '', 'avoid_ip' => '',
    'grant_html' => '2', 'grant_list' => '10', 'grant_view' => '10', 'grant_comment' => '10',
    'grant_write' => '10', 'grant_reply' => '10', 'grant_delete' => '1', 'grant_notice' => '1',
    'grant_view_secret' => '1'
);
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp; <input type=text name=name value='<?= e($data['name']) ?>' <?= $no ? "readonly" : "" ?> size=20 maxlength=40 class=input style=border-color:#b0b0b0></td>
</tr>
...
<tr height=70 bgcolor=#e0e0e0>
  ...
  <td>&nbsp;&nbsp; 
<?php $check = array('' => '', 0 => '', 1 => '', 2 => ''); $check[$data['only_board']] = "checked"; ?>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text  name=bg_image value='<?= e($data['bg_image']) ?>' size=50 maxlength=255 class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text  name=title value='<?= e($data['title']) ?>' size=20 maxlength=250 class=input style=border-color:#b0b0b0> &nbsp; 브라우저 상단의 타이틀을 지정
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text  name=header_url value='<?= e($data['header_url']) ?>' size=40 maxlength=255 class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <textarea name=header cols=70 rows=10 class=textarea style=border-color:b0b0b0><?= e($data['header']) ?></textarea>
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text  name=footer_url value='<?= e($data['footer_url']) ?>' size=40 maxlength=255 class=input style=border-color:#b0b0b0> &nbsp;&nbsp;
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <textarea name=footer cols=70 rows=10 class=textarea style=border-color:#b0b0b0><?= e($data['footer']) ?></textarea>
  </td>
</tr>
...
<?php $check = array('' => '', 0 => '', 1 => '', 2 => ''); $check[$data['use_alllist']] = "checked"; ?>
<tr height=25 bgcolor=#e0e0e0>
...
<?php $check = array('' => '', 0 => '', 1 => '', 2 => ''); $check[$data['use_category']] = "checked"; ?>
<tr height=25 bgcolor=#e0e0e0>
...
<?php $check = array('' => '', 0 => '', 1 => '', 2 => ''); $check[$data['use_html']] = "checked"; ?>
<tr height=25 bgcolor=#e0e0e0>
...
<?php $check = array('' => '', 0 => '', 1 => '', 2 => ''); if ($data['use_showreply']) $check = "checked"; else $check = ""; ?>
<tr height=25 bgcolor=#e0e0e0>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text  name=pds_ext1 value='<?= e($data['pds_ext1']) ?>' size=50 maxlength=250 class=input style=border-color:#b0b0b0><br>&nbsp;&nbsp; 1번 업로드 가능 확장자 지정 (공백시 검사하지않음. 쉼표(,)로 구분) 
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text  name=pds_ext2 value='<?= e($data['pds_ext2']) ?>' size=50 maxlength=250 class=input style=border-color:#b0b0b0><br>&nbsp;&nbsp; 2번 업로드 가능 확장자 지정 (공백시 검사하지않음. 쉼표(,)로 구분)
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <input type=text name=max_upload_size value=2097152 size=10  class=input style=border-color:#b0b0b0> byte &nbsp;&nbsp; (최고한도 : <?= e(get_cfg_var("upload_max_filesize")) ?> byte)
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <textarea name=filter cols=70 rows=6 class=textarea style=border-color:#b0b0b0><?= e(file_get_contents("admin/base_filter.txt")) ?></textarea><br> &nbsp;&nbsp;
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <textarea name=avoid_tag cols=70 rows=6 class=textarea style=border-color:#b0b0b0><?= e(file_get_contents("admin/base_avoid_tag.txt")) ?></textarea><br> &nbsp;&nbsp; HTML을 부분허용했을때 허용하여 주는 태그입니다.<br>
       &nbsp;&nbsp; &lt;,&gt;를 태그 이름만을 입력하세요.<br>
       &nbsp;&nbsp; <b>, (콤마)</b> 로 연결하세요
  </td>
</tr>
...
<tr height=25 bgcolor=#e0e0e0>
  ...
  <td >&nbsp;&nbsp;
     <textarea name=avoid_ip cols=70 rows=4 class=textarea style=border-color:#b0b0b0><?= e($data['avoid_ip']) ?></textarea><br> &nbsp;&nbsp; 차단을 원하는 특정 아이피가 있을때 등록하세요.&nbsp;&nbsp; <b>, (콤마)</b> 로 연결하세요
  </td>
</tr>

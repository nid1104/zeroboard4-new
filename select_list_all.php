...
$result = $connect->all("select name from $admin_table order by name");
...
<input type=hidden name=selected value="<?= e($selected) ?>">
<tr>
...
foreach ($result as $data) {
    ...
    ?>
			<option value="<?= e($data['name']) ?>" <?= $select ?>><?= e($data['name']) ?></option>
<?php
    		$select = "";
}
?>
...
<input type=hidden name=board_name value="<?= e($s_name) ?>">
</form>
</table>
<?php
	foot();

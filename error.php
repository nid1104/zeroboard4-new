...
<?php
      ...
      ?>
		...
		<div align=center><input type=button value='   Move Page   ' onclick="location.href='<?= $url ?>'" style=border-color:#b0b0b0;background-color:#3d3d3d;color:#ffffff;font-size:8pt;font-family:Tahoma;height:23px;>

...
if (is_writable(__DIR__)) $check = 1;
if (!$check) echo "<font color=red>현재 707로 퍼미션이 되어 있지 않습니다. 텔넷이나 FTP에서 퍼미션을 조정하세요.</font><br><br>
                   <div align=center><table border=0><tr><form method=post action=\"" . e(Request::scriptName()) . "\"><td align=center height=30><input type=submit value='퍼미션 조정하였습니다' style=height:20px;></td></tr></table>";

...
<tr>
 <td colspan=2 align=center>
    <a href="javascript:OnOff('sn')"><img src=<?= $dir?>/name_<?= e($sn)?>.gif border=0 name=sn></a>
    <a href="javascript:OnOff('ss')"><img src=<?= $dir?>/subject_<?= e($ss)?>.gif border=0 name=ss></a>
    <a href="javascript:OnOff('sc')"><img src=<?= $dir?>/content_<?= e($sc)?>.gif border=0 name=sc></a><img src=images/t.gif width=35 height=1><br>

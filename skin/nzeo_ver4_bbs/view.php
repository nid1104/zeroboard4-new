...
<img src=<?= e($dir) ?>/t.gif border=0 height=5><br>
...
?>
		...
		<tr>
			<td>
				...
				<img src=<?= e($dir) ?>/t.gif border=0 width=10><br>
				<?= $memo?>
...
<img src=<?= e($dir) ?>/t.gif border=0 height=2><br>


<?php if ($member['level'] <= $setup['grant_comment']){?>
<?= $hide_comment_start?>
<table border=0 cellspacing=0 cellpadding=0 height=1 width=<?= e($width) ?>>
<tr><td height=1 class=line1 style=height:1px><img src=<?= e($dir) ?>/t.gif border=0 height=1></td></tr>
</table>
<img src=./images/t.gif border=0 height=8><br>
<table width=<?= e($width) ?> cellspacing=1 cellpadding=4>

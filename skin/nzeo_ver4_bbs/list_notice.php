...
<tr align=center class=list<?= $coloring % 2?>>
	...
	<td align=left nowrap><?= $hide_cart_start?><input type=checkbox name=cart value="<?= e($data['no']) ?>"><?= $hide_cart_end?>&nbsp;<?= $insert?><?= $subject?> &nbsp;<font class=list_eng style=font-size:7pt><?= $comment_num?></font></td> 

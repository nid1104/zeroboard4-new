...
<form method=post name=write action=write_ok.php onsubmit="return check_submit();" enctype=multipart/form-data><input type=hidden name=page value="<?= e($page) ?>"><input type=hidden name=id value="<?= e($id) ?>"><input type=hidden name=no value="<?= e($no) ?>"><input type=hidden name=select_arrange value="<?= e($select_arrange) ?>"><input type=hidden name=desc value="<?= e($desc) ?>"><input type=hidden name=page_num value="<?= e($page_num) ?>"><input type=hidden name=keyword value="<?= e($keyword) ?>"><input type=hidden name=category value="<?= e($category) ?>"><input type=hidden name=sn value="<?= e($sn) ?>"><input type=hidden name=ss value="<?= e($ss) ?>"><input type=hidden name=sc value="<?= e($sc) ?>"><input type=hidden name=mode value="<?= e($mode) ?>">
...
<tr>
  ...
  <td><input type=text name=name value="<?= e($name)?>" <?= size(20)?> maxlength=20 class=input></td>
...
<tr>
  ...
  <td><input type=text name=email value="<?= e($email)?>" <?= size(40)?> maxlength=200 class=input></td>
...
<tr>
  ...
  <td><input type=text name=homepage value="<?= e($homepage)?>" <?= size(40)?> maxlength=200 class=input></td>
...
<tr valign=top>
  ...
  <td><input type=text name=subject value="<?= e($subject)?>" <?= size(60)?> maxlength=200 style=width:99% class=input></td>
...
<tr>
  ...
  <td><input type=text name=sitelink1 value="<?= e($sitelink1)?>" <?= size(62)?> maxlength=200 class=input style=width:99%></td>
...
<tr>
  ...
  <td><input type=text name=sitelink2 value="<?= e($sitelink2)?>" <?= size(62)?> maxlength=200 class=input style=width:99%></td>
